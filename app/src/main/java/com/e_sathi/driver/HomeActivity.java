...
public class HomeActivity extends AppCompatActivity implements OnMapReadyCallback, LocationEngineListener, TextWatcher, TextView.OnEditorActionListener,NavigationView.OnNavigationItemSelectedListener {
                        ...
                        if (response.code() == 200) {
                            if (response.body() != null) {
                                ...
                                if (distanceResults != null) {
                                    ...
                                    Toast.makeText(HomeActivity.this, "Failed: " + legacyDistanceResponse.responseCode(), Toast.LENGTH_SHORT).show();
                                }
                            }
                        }
                    }
